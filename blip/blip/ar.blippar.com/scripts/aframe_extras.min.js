!(function e(t, i, n) {
...
})(
    {
        ...
        2: [
            function (e, t, i) {
                "use strict";
                e("./src/controls"), e("./src/loaders"), e("./src/misc"), e("./src/pathfinding"), e("./src/primitives");
            },
            { "./src/controls": 13, "./src/loaders": 21, "./src/misc": 26, "./src/pathfinding": 32, "./src/primitives": 40 },
        ],
        3: [
            function (e, t, i) {
                "use strict";
                ...
                (THREE.LoaderUtils = {
                    ...
                    (t.exports = THREE.FBXLoader = (function () {
                        ...
                        function d(e) {
                            ...
                            if ((e.translation && k.fromArray(e.translation), e.rotationOffset && k.add(x.fromArray(e.rotationOffset)), e.rotation)) {
                                (n = e.rotation.map(THREE.Math.degToRad)).push(i), R.makeRotationFromEuler(w.fromArray(n));
                            }
                            if (e.preRotation) {
                                (n = e.preRotation.map(THREE.Math.degToRad)).push(i), T.makeRotationFromEuler(w.fromArray(n)), R.premultiply(T);
                            }
                            if (e.postRotation) {
                                var n = e.postRotation.map(THREE.Math.degToRad);
                                n.push(i), T.makeRotationFromEuler(w.fromArray(n)), T.getInverse(T), R.multiply(T);
                            }
                            return e.scale && t.scale(x.fromArray(e.scale)), t.setPosition(k), t.multiply(R), t;
                        }
                        function p(e) {
                        ...
                        function v(e, t, i) {
                            return void 0 === t && (t = 0), void 0 === i && (i = e.byteLength), THREE.LoaderUtils.decodeText(new Uint8Array(e, t, i));
                        }
                        function m(e, t, i) {
                        ...
                        (e.prototype = {
                            ...
                            parse: function (e, i) {
                                if (
                                    (function (e) {
                                        ...
                                        return e.byteLength >= t.length && t === v(e, 0, t.length);
                                    })(e)
                                )
                                    g = new s().parse(e);
                                else {
                                    ...
                                    if (
                                        !(function (e) {
                                            ...
                                            for (var i = ["K", "a", "y", "d", "a", "r", "a", "\\", "F", "B", "X", "\\", "B", "i", "n", "a", "r", "y", "\\", "\\"], n = 0, o = 0; o < i.length; ++o) if (t(1) === i[o]) return !1;
                                            return !0;
                                        })(n)
                                    )
                                        throw new Error("THREE.FBXLoader: Unknown format.");
                                    if (l(n) < 7e3) throw new Error("THREE.FBXLoader: FBX version not supported, FileVersion: " + l(n));
                                    g = new r().parse(n);
                                }
                                return new t(new THREE.TextureLoader(this.manager).setPath(i).setCrossOrigin(this.crossOrigin)).parse(g);
                            },
                        }),
                            (t.prototype = {
                                constructor: t,
                                parse: function () {
                                    ...
                                    var e = this.parseImages(),
                                        ...
                                        r = new i().parse(o);
                                    return this.parseScene(o, r, n), E;
                                },
                                parseConnections: function () {
                                    ...
                                    if ("Connections" in g) {
                                        g.Connections.connections.forEach(function (t) {
                                            ...
                                            e.get(i).parents.push(r), e.has(n) || e.set(n, { parents: [], children: [] });
                                ...
                                parseImages: function () {
                                    ...
                                    if ("Video" in g.Objects) {
                                        ...
                                        for (var n in i) {
                                            var o = i[n];
                                            if (((e[(c = parseInt(n))] = o.RelativeFilename || o.Filename), "Content" in o)) {
                                                var r = o.Content instanceof ArrayBuffer && o.Content.byteLength > 0,
                                                    s = "string" == typeof o.Content && "" !== o.Content;
                                                if (r || s) {
                                                    var a = this.parseImage(i[n]);
                                                    t[o.RelativeFilename || o.Filename] = a;
                                                }
                                            }
                                        }
                                    }
                                ...
                                parseImage: function (e) {
                                    ...
                                    return window.URL.createObjectURL(new Blob([r], { type: t }));
                                },
                                ...
                                parseTexture: function (e, t) {
                                    ...
                                    var n = e.WrapModeU,
                                        o = e.WrapModeV,
                                        r = void 0 !== n ? n.value : 0,
                                        s = void 0 !== o ? o.value : 0;
                                    if (((i.wrapS = 0 === r ? THREE.RepeatWrapping : THREE.ClampToEdgeWrapping), (i.wrapT = 0 === s ? THREE.RepeatWrapping : THREE.ClampToEdgeWrapping), "Scaling" in e)) {
                                ...
                                loadTexture: function (e, t) {
                                    var i,
                                        ...
                                        o = y.get(e.id).children;
                                    void 0 !== o && o.length > 0 && void 0 !== t[o[0].ID] && ((0 !== (i = t[o[0].ID]).indexOf("blob:") && 0 !== i.indexOf("data:")) || this.textureLoader.setPath(void 0));
                                    var r,
                                        s = e.FileName.slice(-3).toLowerCase();
                                    if ("tga" === s) {
                                        var a = THREE.Loader.Handlers.get(".tga");
                                        null === a ? (console.warn("FBXLoader: TGALoader not found, creating empty placeholder texture for", i), (r = new THREE.Texture())) : (r = a.load(i));
                                    } else "psd" === s ? (console.warn("FBXLoader: PSD textures are not supported, creating empty placeholder texture for", i), (r = new THREE.Texture())) : (r = this.textureLoader.load(i));
                                ...
                                parseMaterials: function (e) {
                                    ...
                                    if ("Material" in g.Objects) {
                                        ...
                                        for (var n in i) {
                                            var o = this.parseMaterial(i[n], e);
                                ...
                                parseMaterial: function (e, t) {
                                    var i = e.id,
                                        n = e.attrName,
                                        r = e.ShadingModel;
                                    if (("object" === (void 0 === r ? "undefined" : o(r)) && (r = r.value), !y.has(i))) return null;
                                    var s,
                                    ...
                                    switch (r.toLowerCase()) {
                                        ...
                                        case "lambert":
                                            ...
                                            break;
                                        default:
                                            console.warn('THREE.FBXLoader: unknown material type "%s". Defaulting to MeshPhongMaterial.', r), (s = new THREE.MeshPhongMaterial({ color: 3342591 }));
                                    }
                                ...
                                parseParameters: function (e, t, i) {
                                    ...
                                    e.BumpFactor && (n.bumpScale = e.BumpFactor.value),
                                        e.Diffuse ? (n.color = new THREE.Color().fromArray(e.Diffuse.value)) : e.DiffuseColor && "Color" === e.DiffuseColor.type && (n.color = new THREE.Color().fromArray(e.DiffuseColor.value)),
                                        e.DisplacementFactor && (n.displacementScale = e.DisplacementFactor.value),
                                        e.Emissive ? (n.emissive = new THREE.Color().fromArray(e.Emissive.value)) : e.EmissiveColor && "Color" === e.EmissiveColor.type && (n.emissive = new THREE.Color().fromArray(e.EmissiveColor.value)),
                                        e.EmissiveFactor && (n.emissiveIntensity = parseFloat(e.EmissiveFactor.value)),
                                        e.Opacity && (n.opacity = parseFloat(e.Opacity.value)),
                                        n.opacity < 1 && (n.transparent = !0),
                                        e.ReflectionFactor && (n.reflectivity = e.ReflectionFactor.value),
                                        e.Shininess && (n.shininess = e.Shininess.value),
                                        e.Specular ? (n.specular = new THREE.Color().fromArray(e.Specular.value)) : e.SpecularColor && "Color" === e.SpecularColor.type && (n.specular = new THREE.Color().fromArray(e.SpecularColor.value));
                                    var o = this;
                                    return (
                                        y.get(i).children.forEach(function (e) {
                                            ...
                                            switch (i) {
                                                case "Bump":
                                                    n.bumpMap = o.getTexture(t, e.ID);
                                                    break;
                                                case "DiffuseColor":
                                                    n.map = o.getTexture(t, e.ID);
                                                    break;
                                                case "DisplacementColor":
                                                    n.displacementMap = o.getTexture(t, e.ID);
                                                    break;
                                                case "EmissiveColor":
                                                    n.emissiveMap = o.getTexture(t, e.ID);
                                                    break;
                                                case "NormalMap":
                                                    n.normalMap = o.getTexture(t, e.ID);
                                                    break;
                                                case "ReflectionColor":
                                                    (n.envMap = o.getTexture(t, e.ID)), (n.envMap.mapping = THREE.EquirectangularReflectionMapping);
                                                    break;
                                                case "SpecularColor":
                                                    n.specularMap = o.getTexture(t, e.ID);
                                                    break;
                                                case "TransparentColor":
                                                    (n.alphaMap = o.getTexture(t, e.ID)), (n.transparent = !0);
                                                    break;
                                                case "AmbientColor":
                                ...
                                getTexture: function (e, t) {
                                    return (
                                        "LayeredTexture" in g.Objects &&
                                            ...
                                            (console.warn("THREE.FBXLoader: layered textures are not supported in three.js. Discarding all but first layer."), (t = y.get(t).children[0].ID)),
                                        e.get(t)
                                    );
                                },
                                    ...
                                    if ("Deformer" in g.Objects) {
                                        ...
                                        for (var n in i) {
                                            var o = i[n],
                                                r = y.get(parseInt(n));
                                            if ("Skin" === o.attrType) {
                                                var s = this.parseSkeleton(r, i);
                                                (s.ID = n), r.parents.length > 1 && console.warn("THREE.FBXLoader: skeleton attached to more than one geometry is not supported."), (s.geometryID = r.parents[0].ID), (e[n] = s);
                                            } else if ("BlendShape" === o.attrType) {
                                                var a = { id: n };
                                                (a.rawTargets = this.parseMorphTargets(r, i)),
                                                    (a.id = n),
                                                    r.parents.length > 1 && console.warn("THREE.FBXLoader: morph target attached to more than one geometry is not supported."),
                                                    (t[n] = a);
                                            }
                                        }
                                    }
                                    ...
                                    return (
                                        e.children.forEach(function (e) {
                                            ...
                                            if ("Cluster" === n.attrType) {
                                                var o = { ID: e.ID, indices: [], weights: [], transform: new THREE.Matrix4().fromArray(n.Transform.a), transformLink: new THREE.Matrix4().fromArray(n.TransformLink.a), linkMode: n.Mode };
                                                "Indexes" in n && ((o.indices = n.Indexes.a), (o.weights = n.Weights.a)), i.push(o);
                                            }
                                        }),
                                        { rawBones: i, bones: [] }
                                    );
                                ...
                                parseMorphTargets: function (e, t) {
                                    for (var i = [], n = 0; n < e.children.length; n++) {
                                        ...
                                        var o = e.children[n],
                                            r = t[o.ID],
                                            s = { name: r.attrName, initialWeight: r.DeformPercent, id: r.id, fullWeights: r.FullWeights.a };
                                        if ("BlendShapeChannel" !== r.attrType) return;
                                        y.get(parseInt(o.ID)).children.forEach(function (e) {
                                ...
                                parseScene: function (e, t, i) {
                                    E = new THREE.Group();
                                    var o = this.parseModels(e.skeletons, t, i),
                                        r = g.Objects.Model,
                                        s = this;
                                    ...
                                    var a = new n().parse();
                                    1 === E.children.length && E.children[0].isGroup && ((E.children[0].animations = a), (E = E.children[0])), (E.animations = a);
                                },
                                parseModels: function (e, t, i) {
                                    ...
                                    for (var r in o) {
                                        ...
                                        if (!l) {
                                            ...
                                            (l.name = THREE.PropertyBinding.sanitizeNodeName(a.attrName)), (l.ID = s);
                                        }
                                        ...
                                        e.parents.forEach(function (e) {
                                            for (var r in t) {
                                                ...
                                                s.rawBones.forEach(function (t, r) {
                                                    if (t.ID === e.ID) {
                                                        var a = o;
                                                        (o = new THREE.Bone()).matrixWorld.copy(t.transformLink), (o.name = THREE.PropertyBinding.sanitizeNodeName(n)), (o.ID = i), (s.bones[r] = o), null !== a && o.add(a);
                                                    }
                                                });
                                            }
                                        }),
                                ...
                                createCamera: function (e) {
                                    ...
                                    if (
                                        ...
                                        var n = 0;
                                        void 0 !== i.CameraProjectionType && 1 === i.CameraProjectionType.value && (n = 1);
                                        var o = 1;
                                        ...
                                        void 0 !== i.AspectWidth && void 0 !== i.AspectHeight && ((s = i.AspectWidth.value), (a = i.AspectHeight.value));
                                        var c = s / a,
                                            l = 45;
                                        ...
                                        switch (n) {
                                            case 0:
                                                (t = new THREE.PerspectiveCamera(l, c, o, r)), null !== h && t.setFocalLength(h);
                                                break;
                                            case 1:
                                                t = new THREE.OrthographicCamera(-s / 2, s / 2, a / 2, -a / 2, o, r);
                                                break;
                                            default:
                                                console.warn("THREE.FBXLoader: Unknown camera type " + n + "."), (t = new THREE.Object3D());
                                        }
                                    }
                                    return t;
                                },
                                createLight: function (e) {
                                    ...
                                    if (
                                        ...
                                        var o = 16777215;
                                        void 0 !== i.Color && (o = new THREE.Color().fromArray(i.Color.value));
                                        var r = void 0 === i.Intensity ? 1 : i.Intensity.value / 100;
                                        void 0 !== i.CastLightOnObject && 0 === i.CastLightOnObject.value && (r = 0);
                                        var s = 0;
                                        void 0 !== i.FarAttenuationEnd && (s = void 0 !== i.EnableFarAttenuation && 0 === i.EnableFarAttenuation.value ? 0 : i.FarAttenuationEnd.value);
                                        switch (n) {
                                            case 0:
                                                t = new THREE.PointLight(o, r, s, 1);
                                                break;
                                            case 1:
                                                t = new THREE.DirectionalLight(o, r);
                                                break;
                                            case 2:
                                                var a = Math.PI / 3;
                                                void 0 !== i.InnerAngle && (a = THREE.Math.degToRad(i.InnerAngle.value));
                                                var c = 0;
                                                void 0 !== i.OuterAngle && ((c = THREE.Math.degToRad(i.OuterAngle.value)), (c = Math.max(c, 1))), (t = new THREE.SpotLight(o, r, s, a, c, 1));
                                                break;
                                            default:
                                                console.warn("THREE.FBXLoader: Unknown light type " + i.LightType.value + ", defaulting to a THREE.PointLight."), (t = new THREE.PointLight(o, r));
                                        }
                                        void 0 !== i.CastShadows && 1 === i.CastShadows.value && (t.castShadow = !0);
                                    }
                                    return t;
                                },
                                createMesh: function (e, t, i) {
                                    ...
                                    return (
                                        e.children.forEach(function (e) {
                                            t.has(e.ID) && (o = t.get(e.ID)), i.has(e.ID) && s.push(i.get(e.ID));
                                        }),
                                        s.length > 1 ? (r = s) : s.length > 0 ? (r = s[0]) : ((r = new THREE.MeshPhongMaterial({ color: 13421772 })), s.push(r)),
                                        ...
                                        o.FBX_Deformer
                                            ? (s.forEach(function (e) {
                                              ...
                                              (n = new THREE.SkinnedMesh(o, r)))
                                            : (n = new THREE.Mesh(o, r)),
                                        n
                                    );
                                },
                                createCurve: function (e, t) {
                                    var i = e.children.reduce(function (e, i) {
                                        ...
                                        n = new THREE.LineBasicMaterial({ color: 3342591, linewidth: 1 });
                                    return new THREE.Line(i, n);
                                },
                                setModelTransforms: function (e, t) {
                                    var i = {};
                                    "RotationOrder" in t && (i.eulerOrder = parseInt(t.RotationOrder.value)),
                                        ...
                                        y.get(e.ID).children.forEach(function (t) {
                                            if ("LookAtProperty" === t.relationship) {
                                                ...
                                                if ("Lcl_Translation" in i) {
                                                    ...
                                                    void 0 !== e.target ? (e.target.position.fromArray(n), E.add(e.target)) : e.lookAt(new THREE.Vector3().fromArray(n));
                                                }
                                            }
                                        });
                                    }
                                ...
                                bindSkeleton: function (e, t, i) {
                                    ...
                                    for (var o in e) {
                                        var r = e[o];
                                        y.get(parseInt(r.ID)).parents.forEach(function (e) {
                                            if (t.has(e.ID)) {
                                                var o = e.ID;
                                                y.get(o).parents.forEach(function (e) {
                                                    if (i.has(e.ID)) {
                                                        i.get(e.ID).bind(new THREE.Skeleton(r.bones), n[e.ID]);
                                                    }
                                                });
                                            }
                                        });
                                        ...
                                        for (var i in t)
                                            if ("BindPose" === t[i].attrType) {
                                                ...
                                                Array.isArray(n)
                                                    ...
                                                    : (e[n.Node] = new THREE.Matrix4().fromArray(n.Matrix.a));
                                            }
                                    }
                                    return e;
                                },
                                createAmbientLight: function () {
                                    if ("GlobalSettings" in g && "AmbientColor" in g.GlobalSettings) {
                                        var e = g.GlobalSettings.AmbientColor.value,
                                            ...
                                            n = e[2];
                                        if (0 !== t || 0 !== i || 0 !== n) {
                                            var o = new THREE.Color(t, i, n);
                                            E.add(new THREE.AmbientLight(o, 1));
                                        }
                                    }
                                },
                                    ...
                                    E.traverse(function (e) {
                                        if (e.isMesh && (e.geometry.morphAttributes.position || e.geometry.morphAttributes.normal)) {
                                            var t = e.uuid,
                                                ...
                                                n = !1;
                                            E.traverse(function (e) {
                                                e.isMesh && e.material.uuid === i && e.uuid !== t && (n = !0);
                                            }),
                            ...
                            (i.prototype = {
                                ...
                                genGeometry: function (e, t, i, n) {
                                    ...
                                    var r = this.parseGeoNode(e, t),
                                        s = this.genBuffers(r),
                                        a = new THREE.Float32BufferAttribute(s.vertex, 3);
                                    if (
                                        (n.applyToBufferAttribute(a),
                                        o.addAttribute("position", a),
                                        s.colors.length > 0 && o.addAttribute("color", new THREE.Float32BufferAttribute(s.colors, 3)),
                                        t && (o.addAttribute("skinIndex", new THREE.Uint16BufferAttribute(s.weightsIndices, 4)), o.addAttribute("skinWeight", new THREE.Float32BufferAttribute(s.vertexWeights, 4)), (o.FBX_Deformer = t)),
                                        s.normal.length > 0)
                                    ) {
                                        var c = new THREE.Float32BufferAttribute(s.normal, 3);
                                        new THREE.Matrix3().getNormalMatrix(n).applyToBufferAttribute(c), o.addAttribute("normal", c);
                                    }
                                    if (
                                        (s.uvs.forEach(function (e, t) {
                                            var i = "uv" + (t + 1).toString();
                                            0 === t && (i = "uv"), o.addAttribute(i, new THREE.Float32BufferAttribute(s.uvs[t], 2));
                                        }),
                                        ...
                                        if (
                                            (s.materialIndex.forEach(function (e, t) {
                                                e !== l && (o.addGroup(h, t - h, l), (l = e), (h = t));
                                            }),
                                            o.groups.length > 0)
                                        ) {
                                            var u = o.groups[o.groups.length - 1],
                                                d = u.start + u.count;
                                            d !== s.materialIndex.length && o.addGroup(d, s.materialIndex.length - d, l);
                                        }
                                        0 === o.groups.length && o.addGroup(0, s.materialIndex.length, s.materialIndex[0]);
                                    }
                                    return this.addMorphTargets(o, e, i, n), o;
                                },
                                parseGeoNode: function (e, t) {
                                    var i = {};
                                    if (
                                        ((i.vertexPositions = void 0 !== e.Vertices ? e.Vertices.a : []),
                                        (i.vertexIndices = void 0 !== e.PolygonVertexIndex ? e.PolygonVertexIndex.a : []),
                                        ...
                                        i.uv = [];
                                        for (var n = 0; e.LayerElementUV[n]; ) i.uv.push(this.parseUVs(e.LayerElementUV[n])), n++;
                                    }
                                    return (
                                        (i.weightTable = {}),
                                        null !== t &&
                                            ...
                                            t.rawBones.forEach(function (e, t) {
                                                e.indices.forEach(function (n, o) {
                                                    void 0 === i.weightTable[n] && (i.weightTable[n] = []), i.weightTable[n].push({ id: t, weight: e.weights[o] });
                                                });
                                            })),
                                        i
                                    );
                                ...
                                genBuffers: function (e) {
                                    ...
                                    return (
                                        e.vertexIndices.forEach(function (p, f) {
                                            ...
                                            var m = [],
                                                g = [];
                                            if ((r.push(3 * p, 3 * p + 1, 3 * p + 2), e.color)) {
                                                T = u(f, i, p, e.color);
                                                a.push(T[0], T[1], T[2]);
                                            }
                                            if (e.skeleton) {
                                                if (
                                                    ...
                                                    o || (console.warn("THREE.FBXLoader: Vertex has more than 4 skinning weights assigned to vertex. Deleting additional weights."), (o = !0));
                                                    var y = [0, 0, 0, 0],
                                                        E = [0, 0, 0, 0];
                                                ...
                                                for (var b = 0; b < 4; ++b) l.push(g[b]), h.push(m[b]);
                                            }
                                            if (e.normal) {
                                                var T = u(f, i, p, e.normal);
                                                s.push(T[0], T[1], T[2]);
                                            }
                                            if (e.material && "AllSame" !== e.material.mappingType) var w = u(f, i, p, e.material)[0];
                                            e.uv &&
                                                e.uv.forEach(function (e, t) {
                                                    var n = u(f, i, p, e);
                                                    void 0 === c[t] && (c[t] = []), c[t].push(n[0]), c[t].push(n[1]);
                                                }),
                                                n++,
                                                v && (d.genFace(t, e, r, w, s, a, c, l, h, n), i++, (n = 0), (r = []), (s = []), (a = []), (c = []), (l = []), (h = []));
                                        }),
                                        t
                                    );
                                },
                                genFace: function (e, t, i, n, o, r, s, a, c, l) {
                                    for (var h = 2; h < l; h++)
                                        e.vertex.push(t.vertexPositions[i[0]]),
                                            ...
                                            t.color &&
                                                ...
                                                e.colors.push(r[1]),
                                                e.colors.push(r[2]),
                                                e.colors.push(r[3 * (h - 1)]),
                                                e.colors.push(r[3 * (h - 1) + 1]),
                                                e.colors.push(r[3 * (h - 1) + 2]),
                                                e.colors.push(r[3 * h]),
                                                e.colors.push(r[3 * h + 1]),
                                                e.colors.push(r[3 * h + 2])),
                                            t.material && "AllSame" !== t.material.mappingType && (e.materialIndex.push(n), e.materialIndex.push(n), e.materialIndex.push(n)),
                                            t.normal &&
                                                (e.normal.push(o[0]),
                                                e.normal.push(o[1]),
                                                e.normal.push(o[2]),
                                ...
                                addMorphTargets: function (e, t, i, n) {
                                    if (null !== i) {
                                        ...
                                        i.rawTargets.forEach(function (i) {
                                            var r = g.Objects.Geometry[i.geoID];
                                            void 0 !== r && o.genMorphGeometry(e, t, r, n);
                                        });
                                    }
                                },
                                genMorphGeometry: function (e, t, i, n) {
                                    var o = new THREE.BufferGeometry();
                                    i.attrName && (o.name = i.attrName);
                                    for (
                                        var r = void 0 !== t.PolygonVertexIndex ? t.PolygonVertexIndex.a : [],
                                        ...
                                        var h = 3 * c[l];
                                        (s[h] += a[3 * l]), (s[h + 1] += a[3 * l + 1]), (s[h + 2] += a[3 * l + 2]);
                                    }
                                    var u = { vertexIndices: r, vertexPositions: s },
                                        d = this.genBuffers(u),
                                        p = new THREE.Float32BufferAttribute(d.vertex, 3);
                                    (p.name = i.attrName), n.applyToBufferAttribute(p), e.morphAttributes.position.push(p);
                                },
                                parseNormals: function (e) {
                                    var t = e.MappingInformationType,
                                        ...
                                        n = e.Normals.a,
                                        o = [];
                                    return "IndexToDirect" === i && ("NormalIndex" in e ? (o = e.NormalIndex.a) : "NormalsIndex" in e && (o = e.NormalsIndex.a)), { dataSize: 3, buffer: n, indices: o, mappingType: t, referenceType: i };
                                },
                                parseUVs: function (e) {
                                    var t = e.MappingInformationType,
                                        i = e.ReferenceInformationType,
                                        n = e.UV.a,
                                        o = [];
                                    return "IndexToDirect" === i && (o = e.UVIndex.a), { dataSize: 2, buffer: n, indices: o, mappingType: t, referenceType: i };
                                },
                                parseVertexColors: function (e) {
                                    var t = e.MappingInformationType,
                                        ...
                                        n = e.Colors.a,
                                        o = [];
                                    return "IndexToDirect" === i && (o = e.ColorIndex.a), { dataSize: 4, buffer: n, indices: o, mappingType: t, referenceType: i };
                                },
                                parseMaterialIndices: function (e) {
                                    var t = e.MappingInformationType,
                                        i = e.ReferenceInformationType;
                                    if ("NoMappingInformation" === t) return { dataSize: 1, buffer: [0], indices: [0], mappingType: "AllSame", referenceType: i };
                                    for (var n = e.Materials.a, o = [], r = 0; r < n.length; ++r) o.push(r);
                                ...
                                parseNurbsGeometry: function (e) {
                                    if (void 0 === THREE.NURBSCurve)
                                        return console.error("THREE.FBXLoader: The loader relies on THREE.NURBSCurve for any nurbs present in the model. Nurbs will show up as empty geometry."), new THREE.BufferGeometry();
                                    ...
                                    for (var i = t - 1, n = e.KnotVector.a, o = [], r = e.Points.a, s = 0, a = r.length; s < a; s += 4) o.push(new THREE.Vector4().fromArray(r, s));
                                    var c, l;
                                    ...
                                    var h = new THREE.NURBSCurve(i, n, o, c, l).getPoints(7 * o.length),
                            ...
                            (n.prototype = {
                                ...
                                parseAnimationCurveNodes: function () {
                                    ...
                                    for (var i in e) {
                                        ...
                                        if (null !== n.attrName.match(/S|R|T|DeformPercent/)) {
                                            var o = { id: n.id, attr: n.attrName, curves: {} };
                                            t.set(o.id, o);
                                        }
                                    }
                                    return t;
                                ...
                                parseAnimationCurves: function (e) {
                                    ...
                                    for (var i in t) {
                                        var n = { id: t[i].id, times: t[i].KeyTime.a.map(h), values: t[i].KeyValueFloat.a },
                                            o = y.get(n.id);
                                        if (void 0 !== o) {
                                            var r = o.parents[0].ID,
                                                s = o.parents[0].relationship;
                                            s.match(/X/) ? (e.get(r).curves.x = n) : s.match(/Y/) ? (e.get(r).curves.y = n) : s.match(/Z/) ? (e.get(r).curves.z = n) : s.match(/d|DeformPercent/) && e.has(r) && (e.get(r).curves.morph = n);
                                        }
                                    }
                                },
                                parseAnimationLayers: function (e) {
                                    ...
                                    for (var n in t) {
                                        ...
                                        if (void 0 !== r) {
                                            var s = this;
                                            r.children.forEach(function (t, i) {
                                                if (e.has(t.ID)) {
                                                    var n = e.get(t.ID);
                                                    if (void 0 !== n.curves.x || void 0 !== n.curves.y || void 0 !== n.curves.z) {
                                                        if (void 0 === o[i]) {
                                                            y.get(t.ID).parents.forEach(function (e) {
                                                                void 0 !== e.relationship && (u = e.ID);
                                                            });
                                                            var r = g.Objects.Model[u.toString()],
                                                                a = {
                                                                    modelName: THREE.PropertyBinding.sanitizeNodeName(r.attrName),
                                                                    initialPosition: [0, 0, 0],
                                                                    initialRotation: [0, 0, 0],
                                                                    initialScale: [1, 1, 1],
                                                                    transform: s.getModelAnimTransform(r),
                                                                };
                                                            "PreRotation" in r && (a.preRotations = r.PreRotation.value), "PostRotation" in r && (a.postRotations = r.PostRotation.value), (o[i] = a);
                                                        }
                                                        o[i][n.attr] = n;
                                                        ...
                                                        if (void 0 === o[i]) {
                                                            ...
                                                            var l = y.get(c).parents[0].ID,
                                                                ...
                                                                r = g.Objects.Model[u],
                                                                a = { modelName: THREE.PropertyBinding.sanitizeNodeName(r.attrName), morphName: g.Objects.Deformer[c].attrName };
                                                            o[i] = a;
                                                        }
                                                        o[i][n.attr] = n;
                                                    }
                                ...
                                parseAnimStacks: function (e) {
                                    var t = g.Objects.AnimationStack,
                                        i = {};
                                    for (var n in t) {
                                        var o = y.get(parseInt(n)).children;
                                ...
                                generateTracks: function (e) {
                                    var t = [],
                                        ...
                                        o = new THREE.Vector3();
                                    if ((e.transform && e.transform.decompose(i, n, o), (i = i.toArray()), (n = new THREE.Euler().setFromQuaternion(n).toArray()), (o = o.toArray()), void 0 !== e.T && Object.keys(e.T.curves).length > 0)) {
                                        var r = this.generateVectorTrack(e.modelName, e.T.curves, i, "position");
                                        void 0 !== r && t.push(r);
                                    }
                                    if (void 0 !== e.R && Object.keys(e.R.curves).length > 0) {
                                        var s = this.generateRotationTrack(e.modelName, e.R.curves, n, e.preRotations, e.postRotations);
                                        void 0 !== s && t.push(s);
                                    }
                                    if (void 0 !== e.S && Object.keys(e.S.curves).length > 0) {
                                        var a = this.generateVectorTrack(e.modelName, e.S.curves, o, "scale");
                                        void 0 !== a && t.push(a);
                                    }
                                ...
                                generateVectorTrack: function (e, t, i, n) {
                                    var o = this.getTimesForAllAxes(t),
                                        r = this.getKeyframeTrackValues(o, t, i);
                                    return new THREE.VectorKeyframeTrack(e + "." + n, o, r);
                                },
                                generateRotationTrack: function (e, t, i, n, o) {
                                    void 0 !== t.x && (this.interpolateRotations(t.x), (t.x.values = t.x.values.map(THREE.Math.degToRad))),
                                    ...
                                    void 0 !== n && ((n = n.map(THREE.Math.degToRad)).push("ZYX"), (n = new THREE.Euler().fromArray(n)), (n = new THREE.Quaternion().setFromEuler(n))),
                                        void 0 !== o && ((o = o.map(THREE.Math.degToRad)).push("ZYX"), (o = new THREE.Euler().fromArray(o)), (o = new THREE.Quaternion().setFromEuler(o).inverse()));
                                    for (var a = new THREE.Quaternion(), c = new THREE.Euler(), l = [], h = 0; h < s.length; h += 3)
                                        c.set(s[h], s[h + 1], s[h + 2], "ZYX"), a.setFromEuler(c), void 0 !== n && a.premultiply(n), void 0 !== o && a.multiply(o), a.toArray(l, (h / 3) * 4);
                                    return new THREE.QuaternionKeyframeTrack(e + ".quaternion", r, l);
                                },
                                generateMorphTrack: function (e) {
                                    var t = e.DeformPercent.curves.morph,
                                        ...
                                        n = E.getObjectByName(e.modelName).morphTargetDictionary[e.morphName];
                                    return new THREE.NumberKeyframeTrack(e.modelName + ".morphTargetInfluences[" + n + "]", t.times, i);
                                },
                                ...
                                getKeyframeTrackValues: function (e, t, i) {
                                    ...
                                    return (
                                        e.forEach(function (e) {
                                            if ((t.x && (r = t.x.times.indexOf(e)), t.y && (s = t.y.times.indexOf(e)), t.z && (a = t.z.times.indexOf(e)), -1 !== r)) {
                                                var i = t.x.values[r];
                                                o.push(i), (n[0] = i);
                                            } else o.push(n[0]);
                                            if (-1 !== s) {
                                ...
                                interpolateRotations: function (e) {
                                    for (var t = 1; t < e.values.length; t++) {
                                        var i = e.values[t - 1],
                                            ...
                                            o = Math.abs(n);
                                        if (o >= 180) {
                                            for (var r = o / 180, s = n / r, a = i + s, c = e.times[t - 1], l = (e.times[t] - c) / r, h = c + l, u = [], d = []; h < e.times[t]; ) u.push(h), (h += l), d.push(a), (a += s);
                            ...
                            (r.prototype = {
                                    ...
                                    return (
                                        i.forEach(function (e, n) {
                                            var o = e.match(/^[\s\t]*;/),
                                                r = e.match(/^[\s\t]*$/);
                                            if (!o && !r) {
                                                var s = e.match("^\\t{" + t.currentIndent + "}(\\w+):(.*){", ""),
                                                    a = e.match("^\\t{" + t.currentIndent + "}(\\w+):[\\s\\t\\r\\n](.*)"),
                                                    c = e.match("^\\t{" + (t.currentIndent - 1) + "}}");
                                                s ? t.parseNodeBegin(e, s) : a ? t.parseNodeProperty(e, a, i[++n]) : c ? t.popStack() : e.match(/^[^\s\t}]/) && t.parseNodePropertyContinued(e);
                                            }
                                        }),
                                        this.allNodes
                                    );
                                ...
                                parseNodeBegin: function (e, t) {
                                    ...
                                    0 === this.currentIndent
                                        ...
                                        : i in s
                                        ? ("PoseNode" === i ? s.PoseNode.push(o) : void 0 !== s[i].id && ((s[i] = {}), (s[i][s[i].id] = s[i])), "" !== r.id && (s[i][r.id] = o))
                                        : "number" == typeof r.id
                                        ? ((s[i] = {}), (s[i][r.id] = o))
                                ...
                                parseNodeProperty: function (e, t, i) {
                                    ...
                                    "Content" === n && "," === o && (o = i.replace(/"/g, "").replace(/,$/, "").trim());
                                    ...
                                    if ("Properties70" !== r.name) {
                                        ...
                                        "Node" === n && (r.id = o), n in r && Array.isArray(r[n]) ? r[n].push(o) : "a" !== n ? (r[n] = o) : (r.a = o), this.setCurrentProp(r, n), "a" === n && "," !== o.slice(-1) && (r.a = f(o));
                                ...
                                parseNodeSpecialProperty: function (e, t, i) {
                                    ...
                                    (this.getPrevNode()[o] = { type: r, type2: s, flag: a, value: c }), this.setCurrentProp(this.getPrevNode(), o);
                                },
                            }),
                            (s.prototype = {
                                constructor: s,
                                ...
                                parseNode: function (e, t) {
                                    var i = {},
                                        ...
                                        r = (t >= 7500 ? e.getUint64() : e.getUint32(), e.getUint8()),
                                        s = e.getString(r);
                                    if (0 === n) return null;
                                    for (var a = [], c = 0; c < o; c++) a.push(this.parseProperty(e));
                                    var l = a.length > 0 ? a[0] : "",
                                        h = a.length > 1 ? a[1] : "",
                                        u = a.length > 2 ? a[2] : "";
                                    for (i.singleProperty = 1 === o && e.getOffset() === n; n > e.getOffset(); ) {
                                        var d = this.parseNode(e, t);
                                        null !== d && this.parseSubNode(s, i, d);
                                    }
                                    return (i.propertyList = a), "number" == typeof l && (i.id = l), "" !== h && (i.attrName = h), "" !== u && (i.attrType = u), "" !== s && (i.name = s), i;
                                },
                                parseSubNode: function (e, t, i) {
                                    if (!0 === i.singleProperty) {
                                        ...
                                        0 === s.indexOf("Lcl ") && (s = s.replace("Lcl ", "Lcl_")),
                                            ...
                                            (r = "Color" === a || "ColorRGB" === a || "Vector" === a || "Vector3D" === a || 0 === a.indexOf("Lcl_") ? [i.propertyList[4], i.propertyList[5], i.propertyList[6]] : i.propertyList[4]),
                                        ...
                                        void 0 === t[i.name]
                                            ? "number" == typeof i.id
                                                ...
                                                : (t[i.name] = i)
                                            : "PoseNode" === i.name
                                            ? (Array.isArray(t[i.name]) || (t[i.name] = [t[i.name]]), t[i.name].push(i))
                                ...
                                parseProperty: function (e) {
                                    ...
                                    switch (t) {
                                        ...
                                        case "l":
                                            ...
                                            var s = new a(new Zlib.Inflate(new Uint8Array(e.getArrayBuffer(r))).decompress().buffer);
                                            switch (t) {
                                                case "b":
                                                case "c":
                            ...
                            (a.prototype = {
                                ...
                                getInt64: function () {
                                    var e, t;
                                    return (
                                        this.littleEndian ? ((e = this.getUint32()), (t = this.getUint32())) : ((t = this.getUint32()), (e = this.getUint32())),
                                        2147483648 & t ? ((t = 4294967295 & ~t), 4294967295 === (e = 4294967295 & ~e) && (t = (t + 1) & 4294967295), (e = (e + 1) & 4294967295), -(4294967296 * t + e)) : 4294967296 * t + e
                                    );
                                },
        ...
        5: [
            function (e, t, i) {
                ...
                t.exports = function (e, t, i) {
                    (this.type = e), (this.index = t), (this.pressed = i.pressed), (this.value = i.value);
                };
            },
            {},
        ],
        6: [
            function (e, t, i) {
                ...
                t.exports = {
                    size: 5,
                    cellSize: 10,
                    extrudeSettings: { amount: 1, bevelEnabled: !0, bevelSegments: 1, steps: 1, bevelSize: 0.5, bevelThickness: 0.5 },
                    autogenerated: !0,
                    cells: [
                    ...
                    return new i(function (i, o) {
                        var r = t.timeout || 5e3,
                            ...
                            a = (function (e, t) {
                                ...
                                return (i.type = "text/javascript"), (i.async = !0), (i.id = t), (i.src = e), i;
                            })(e, s),
                        ...
                        a.addEventListener("load", function (e) {
                            ...
                            a.addEventListener("error", function (t) {
                                o(new Error("Script request to " + e + " failed " + t)), l(c), n(s);
                            }),
                            (function (e) {
        ...
        8: [
            function (e, t, i) {
                ...
                (r.Board = function (e, t) {
                    ...
                    (this.tiles = []), (this.tileGroup = null), (this.group = new THREE.Object3D()), (this.grid = null), (this.overlay = null), (this.finder = new r.AStarFinder(t)), r.Loader.init(), this.setGrid(e);
                }),
                    (r.Board.prototype = {
                        ...
                        addTile: function (e) {
                            -1 === this.tiles.indexOf(e) && (this.tiles.push(e), this.snapTileToGrid(e), (e.position.y = 0), this.tileGroup.add(e.mesh), this.grid.add(e.cell), (e.cell.tile = e));
                        },
                        ...
                        getTileAtCell: function (e) {
                            ...
                            return e.tile || (void 0 !== this.grid.cells[t] ? this.grid.cells[t].tile : null);
                        },
                    ...
                    (r.HexGrid = function (e) {
                        (e = e || {}), (this.type = r.HEX), (this.size = 5), (this.cellSize = void 0 === e.cellSize ? 10 : e.cellSize), (this.cells = {}), (this.numCells = 0), (this.extrudeSettings = null), (this.autogenerated = !1);
                        var t,
                            i = [];
                        ...
                        this.cellShape.lineTo(i[0].x, i[0].y),
                            ...
                            (this._hashDelimeter = "."),
                            (this._directions = [new r.Cell(1, -1, 0), new r.Cell(1, 0, -1), new r.Cell(0, 1, -1), new r.Cell(-1, 1, 0), new r.Cell(-1, 0, 1), new r.Cell(0, -1, 1)]),
                            (this._diagonals = [new r.Cell(2, -1, -1), new r.Cell(1, 1, -2), new r.Cell(-1, 2, -1), new r.Cell(-2, 1, 1), new r.Cell(-1, -1, 2), new r.Cell(1, -2, 1)]),
                            (this._list = []),
                    ...
                    (r.HexGrid.prototype = {
                        cellToPixel: function (e) {
                            return (this._vec3.x = e.q * this._cellWidth * 0.75), (this._vec3.y = e.h), (this._vec3.z = -(e.s - e.r) * this._cellLength * 0.5), this._vec3;
                        },
                        ...
                        getNeighbors: function (e, t, i) {
                            ...
                            for (this._list.length = 0, n = 0; r > n; n++) this._cel.copy(e), this._cel.add(this._directions[n]), !(o = this.cells[this.cellToHash(this._cel)]) || (i && !i(e, o)) || this._list.push(o);
                            if (t) for (n = 0; r > n; n++) this._cel.copy(e), this._cel.add(this._diagonals[n]), !(o = this.cells[this.cellToHash(this._cel)]) || (i && !i(e, o)) || this._list.push(o);
                            return this._list;
                        },
                        ...
                        clearPath: function () {
                            var e, t;
                            for (e in this.cells) ((t = this.cells[e])._calcCost = 0), (t._priority = 0), (t._parent = null), (t._visited = !1);
                        },
                        traverse: function (e) {
                            var t;
                        ...
                        generateTile: function (e, t, i) {
                            ...
                            o || ((this.extrudeSettings.amount = n), (o = new THREE.ExtrudeGeometry(this.cellShape, this.extrudeSettings)), (this._geoCache[n] = o));
                            var s = new r.Tile({ size: this.cellSize, scale: t, cell: e, geometry: o, material: i });
                            return (e.tile = s), s;
                        },
                        generateTiles: function (e) {
                            e = e || {};
                            var t = [],
                                i = { tileScale: 0.95, cellSize: this.cellSize, material: null, extrudeSettings: { amount: 1, bevelEnabled: !0, bevelSegments: 1, steps: 1, bevelSize: 0.5, bevelThickness: 0.5 } };
                            (i = r.Tools.merge(i, e)),
                            ...
                            var n, o, s;
                            for (n in this.cells) (s = this.cells[n]), (o = this.generateTile(s, i.tileScale, i.material)).position.copy(this.cellToPixel(s)), (o.position.y = 0), t.push(o);
                            return t;
                        },
                        generateTilePoly: function (e) {
                            e || (e = new THREE.MeshBasicMaterial({ color: 2405631 }));
                            var t = new THREE.Mesh(this.cellShapeGeo, e);
                            return this._vec3.set(1, 0, 0), t.rotateOnAxis(this._vec3, r.PI / 2), t;
                        },
                        generate: function (e) {
                            (e = e || {}), (this.size = void 0 === e.size ? this.size : e.size);
                            var t, i, n, o;
                            for (t = -this.size; t < this.size + 1; t++)
                                for (i = -this.size; i < this.size + 1; i++) (n = -t - i), Math.abs(t) <= this.size && Math.abs(i) <= this.size && Math.abs(n) <= this.size && ((o = new r.Cell(t, i, n)), this.add(o));
                        },
                        generateOverlay: function (e, t, i) {
                            ...
                            for (n = -e; e + 1 > n; n++)
                                for (o = -e; e + 1 > o; o++)
                                    if (((s = -n - o), Math.abs(n) <= e && Math.abs(o) <= e && Math.abs(s) <= e)) {
                                        this._cel.set(n, o, s);
                                        var c = new THREE.Line(a, i);
                                        c.position.copy(this.cellToPixel(this._cel)), (c.rotation.x = 90 * r.DEG_TO_RAD), t.add(c);
                                    }
                        },
                        add: function (e) {
                        ...
                        toJSON: function () {
                            var e,
                                ...
                                n = [];
                            for (t in this.cells) (e = this.cells[t]), n.push({ q: e.q, r: e.r, s: e.s, h: e.h, walkable: e.walkable, userData: e.userData });
                            return (i.cells = n), i;
                        },
                        ...
                        _cubeRound: function (e) {
                            var t = Math.round(e.q),
                                ...
                                r = Math.abs(i - e.r),
                                s = Math.abs(n - e.s);
                            return o > r && o > s ? (t = -i - n) : r > s ? (i = -t - n) : (n = -t - i), this._cel.set(t, i, n);
                        },
                    }),
                    (r.HexGrid.prototype.constructor = r.HexGrid),
                    (r.SqrGrid = function (e) {
                        (e = e || {}), (this.type = r.SQR), (this.size = 5), (this.cellSize = void 0 === e.cellSize ? 10 : e.cellSize), (this.cells = {}), (this.numCells = 0), (this.extrudeSettings = null), (this.autogenerated = !1);
                        var t = [];
                        t.push(new THREE.Vector3()),
                            ...
                            (this._hashDelimeter = "."),
                            (this._directions = [new r.Cell(1, 0, 0), new r.Cell(0, -1, 0), new r.Cell(-1, 0, 0), new r.Cell(0, 1, 0)]),
                            (this._diagonals = [new r.Cell(-1, -1, 0), new r.Cell(-1, 1, 0), new r.Cell(1, 1, 0), new r.Cell(1, -1, 0)]),
                            (this._list = []),
                            (this._vec3 = new THREE.Vector3()),
                            (this._cel = new r.Cell()),
                            (this._conversionVec = new THREE.Vector3()),
                    ...
                    (r.SqrGrid.prototype = {
                        ...
                        generateTiles: function (e) {
                            ...
                            var t = [],
                                i = { tileScale: 0.95, cellSize: this.cellSize, material: null, extrudeSettings: { amount: 1, bevelEnabled: !0, bevelSegments: 1, steps: 1, bevelSize: 0.5, bevelThickness: 0.5 } };
                            (i = r.Tools.merge(i, e)), (this.cellSize = i.cellSize), (this._fullCellSize = 2 * this.cellSize), (this.autogenerated = !0), (this.extrudeSettings = i.extrudeSettings);
                            var n, o, s;
                            for (n in this.cells) (s = this.cells[n]), (o = this.generateTile(s, i.tileScale, i.material)).position.copy(this.cellToPixel(s)), (o.position.y = 0), t.push(o);
                            return t;
                        },
                        ...
                        generate: function (e) {
                            ...
                            for (t = -o; o > t; t++) for (i = -o; o > i; i++) (n = new r.Cell(t, i + 1)), this.add(n);
                        },
                        generateOverlay: function (e, t, i) {
                            var n,
                                o,
                            ...
                            for (n = -s; s > n; n++)
                                for (o = -s; s > o; o++) {
                                    ...
                                    a.position.copy(this.cellToPixel(this._cel)), (a.rotation.x = 90 * r.DEG_TO_RAD), t.add(a);
                                }
                        },
                        add: function (e) {
                            var t = this.cellToHash(e);
                    ...
                    (r.Tile = function (e) {
                        ...
                        if (!(t = r.Tools.merge(t, e)).cell || !t.geometry) throw new Error("Missing vg.Tile configuration");
                        (this.cell = t.cell),
                            ...
                            this.material || (this.material = new THREE.MeshPhongMaterial({ color: r.Tools.randomizeRGB("30, 30, 30", 13) })),
                            ...
                            this.material.emissive ? (this._emissive = this.material.emissive.getHex()) : (this._emissive = null);
                    }),
                    (r.Tile.prototype = {
                        select: function () {
                        ...
                        (e.generateID = function () {
                            ...
                            ((e.prototype = {
                                ...
                                addNode: function (t) {
                                    ...
                                    return (i.obj = t), (i.free = !1), (this.objToNodeMap[t.uniqueID] = i), i;
                                },
                                ...
                                moveUp: function (e) {
                                    ...
                                    if (t.prev) {
                                        ...
                                        var o = t.next;
                                        n && (n.next = t), (t.next = i), (t.prev = i.prev), (i.next = o), (i.prev = t), this.first == i && (this.first = t);
                                    }
                                },
                                moveDown: function (e) {
                                    var t = this.getNode(e);
                                ...
                                sort: function (e) {
                                    ...
                                    for (this.clear(), n.sort(e), i = n.length, t = 0; i > t; t++) this.add(n[t]);
                                },
                                remove: function (e) {
                                    var t = this.getNode(e);
                                    return (
                                ...
                                shift: function () {
                                    ...
                                    return 0 === this.length
                                        ? null
                                        : (e.prev && (e.prev.next = e.next), e.next && (e.next.prev = e.prev), (this.first = e.next), e.next || (this.last = null), (e.free = !0), (e.prev = null), (e.next = null), this.length--, e.obj);
                                },
                                pop: function () {
                                    var e = this.last;
                                    return 0 === this.length
                                        ? null
                                        : (e.prev && (e.prev.next = e.next), e.next && (e.next.prev = e.prev), (this.last = e.prev), e.prev || (this.first = null), (e.free = !0), (e.prev = null), (e.next = null), this.length--, e.obj);
                                },
                                concat: function (e) {
                    ...
                    (function () {
                        var e = function (e, t, i, n, o) {
                            (this._listener = t), (this.isOnce = i), (this.context = n), (this.signal = e), (this._priority = o || 0);
                        };
                        (e.prototype = {
                            active: !0,
                            params: null,
                        ...
                        ((t.prototype = {
                            ...
                            _registerListener: function (t, i, n, o) {
                                ...
                                if (-1 !== s) {
                                    if ((r = this._bindings[s]).isOnce !== i) throw new Error("You cannot add" + (i ? "" : "Once") + "() then add" + (i ? "Once" : "") + "() the same listener without removing the relationship first.");
                            ...
                            _indexOfListener: function (e, t) {
                                for (var i, n = this._bindings.length; n--; ) if ((i = this._bindings[n])._listener === e && i.context === t) return n;
                                return -1;
                            },
                            has: function (e, t) {
                            ...
                            dispatch: function () {
                                if (this.active) {
                                    ...
                                    if ((this.memorize && (this._prevParams = t), i)) {
                                        ...
                                        do {
                                            i--;
                                        } while (e[i] && this._shouldPropagate && !1 !== e[i].execute(t));
                                    }
                                }
                            },
                            forget: function () {
                    ...
                    (r.AStarFinder = function (e) {
                        ...
                        (t = r.Tools.merge(t, e)), (this.allowDiagonal = t.allowDiagonal), (this.heuristicFilter = t.heuristicFilter), (this.list = new r.LinkedList());
                    }),
                    (r.AStarFinder.prototype = {
                        findPath: function (e, t, i, n) {
                            var o, s, a, c, l, h;
                            for (i = i || this.heuristicFilter, n.clearPath(), this.list.clear(), this.list.add(e); this.list.length > 0; ) {
                                if ((this.list.sort(this.compare), (o = this.list.shift()), (o._visited = !0), o === t)) return r.PathUtil.backtrace(t);
                                for (l = 0, h = (a = n.getNeighbors(o, this.allowDiagonal, i)).length; h > l; l++)
                                    if ((c = a[l]).walkable && ((s = o._calcCost + n.distance(o, c)), !c._visited || s < c._calcCost)) {
                                        if (((c._visited = !0), (c._parent = o), (c._calcCost = s), (c._priority = s + n.distance(t, c)), c === t)) return r.PathUtil.backtrace(t);
                                        this.list.add(c);
                                    }
                            }
                            return null;
                    ...
                    (r.PathUtil = {
                        ...
                        pathLength: function (e) {
                            var t,
                                ...
                                r,
                                s = 0;
                            for (t = 1; t < e.length; ++t) (i = e[t - 1]), (n = e[t]), (o = i[0] - n[0]), (r = i[1] - n[1]), (s += Math.sqrt(o * o + r * r));
                            return s;
                        },
                        interpolate: function (e, t, i, n) {
                            var o,
                                ...
                                h = Math.abs,
                                u = [];
                            for (s = h(i - e), a = h(n - t), o = i > e ? 1 : -1, r = n > t ? 1 : -1, c = s - a; e !== i || t !== n; ) u.push([e, t]), (l = 2 * c) > -a && ((c -= a), (e += o)), s > l && ((c += s), (t += r));
                            return u;
                        },
                        expandPath: function (e) {
                            var t,
                                ...
                                c = e.length;
                            if (2 > c) return a;
                            for (r = 0; c - 1 > r; ++r) for (t = e[r], i = e[r + 1], o = (n = this.interpolate(t[0], t[1], i[0], i[1])).length, s = 0; o - 1 > s; ++s) a.push(n[s]);
                        ...
                        smoothenPath: function (e, t) {
                            ...
                            for (s = [[(i = v), (n = m)]], c = 2; f > c; ++c) {
                                for (o = (h = t[c])[0], r = h[1], u = this.interpolate(i, n, o, r), p = !1, l = 1; l < u.length; ++l)
                        ...
                        compressPath: function (e) {
                            ...
                            var t,
                                ...
                                d = h - c,
                                p = u - l;
                            for (d /= r = Math.sqrt(d * d + p * p), p /= r, a.push([c, l]), s = 2; s < e.length; s++)
                                (t = h), (i = u), (n = d), (o = p), (d = (h = e[s][0]) - t), (p = (u = e[s][1]) - i), (p /= r = Math.sqrt(d * d + p * p)), ((d /= r) !== n || p !== o) && a.push([t, i]);
                            return a.push([h, u]), a;
                        },
                    }),
                    (r.Loader = {
                    ...
                    (r.MouseCaster = function (e, t, i) {
                        (this.down = !1),
                            ...
                            (i = i || document).addEventListener("mousemove", this._onDocumentMouseMove.bind(this), !1),
                            ...
                            if (this.active) {
                                ...
                                i.length > 0
                                    ? ((e = i[0]),
                                      ...
                                      this.pickedObject != t &&
                                          (this.pickedObject && this.signal.dispatch(r.MouseCaster.OUT, this.pickedObject), (this.pickedObject = t), (this.selectedObject = null), this.signal.dispatch(r.MouseCaster.OVER, this.pickedObject)),
                                      this.position.copy(e.point),
                                      (this.screenPosition.z = e.distance))
                                    : (this.pickedObject && this.signal.dispatch(r.MouseCaster.OUT, this.pickedObject), (this.pickedObject = null), (this.selectedObject = null)),
                                    (this.allHits = i);
                            }
                        },
                            ...
                            return (
                                ...
                                this._preventDefault
                                    ...
                                    : (this.pickedObject && (this.selectedObject = this.pickedObject),
                                      ...
                                      void this.signal.dispatch(r.MouseCaster.DOWN, this.pickedObject))
                            );
                        },
                            ...
                            return (
                                ...
                                this._preventDefault
                                    ...
                                    : ((this.shift = e.shiftKey),
                                      ...
                                      this.selectedObject && this.pickedObject && this.selectedObject.uniqueID === this.pickedObject.uniqueID && this.signal.dispatch(r.MouseCaster.CLICK, this.pickedObject),
                                      (this.down = 1 !== e.which && this.down),
                                      void (this.rightDown = 3 !== e.which && this.rightDown))
                            );
                        },
                        _onDocumentMouseMove: function (e) {
                            e.preventDefault(), (this.screenPosition.x = (e.clientX / window.innerWidth) * 2 - 1), (this.screenPosition.y = (-e.clientY / window.innerHeight) * 2 + 1);
                        },
                        _onMouseWheel: function (e) {
                            if (this.active) {
                                e.preventDefault(), e.stopPropagation();
                                var t = 0;
                                void 0 !== e.wheelDelta ? (t = e.wheelDelta) : void 0 !== e.detail && (t = -e.detail), t > 0 ? this.wheel++ : this.wheel--, this.signal.dispatch(r.MouseCaster.WHEEL, this.wheel);
                            }
                        },
                    }),
                    ...
                    (r.Scene = function (e, t) {
                        var i = {
                            ...
                            n = { minDistance: 100, maxDistance: 1e3, zoomSpeed: 2, noZoom: !1 };
                        if (
                            ((i = r.Tools.merge(i, e)),
                            "boolean" != typeof t && (n = r.Tools.merge(n, t)),
                            (this.renderer = new THREE.WebGLRenderer({ alpha: i.alpha, antialias: i.antialias })),
                            ...
                            this.camera = new THREE.OrthographicCamera(o / -2, o / 2, s / 2, s / -2, 1, 5e3);
                    ...
                    (r.SelectionManager = function (e) {
                        (this.mouse = e), (this.onSelect = new r.Signal()), (this.onDeselect = new r.Signal()), (this.selected = null), (this.toggleSelection = !1), this.mouse.signal.add(this.onMouse, this);
                    }),
                    (r.SelectionManager.prototype = {
                        select: function (e, t) {
                            e &&
                                ...
                                e.selected ? this.toggleSelection && (t && this.onDeselect.dispatch(e), e.deselect()) : e.select(),
                                (this.selected = e),
                    ...
                    (r.Tools = {
                        ...
                        random: function (e, t) {
                            return 1 === arguments.length ? Math.random() * e - 0.5 * e : Math.random() * (t - e) + e;
                        },
                        randomInt: function (e, t) {
                            return 1 === arguments.length ? (Math.random() * e - 0.5 * e) | 0 : (Math.random() * (t - e + 1) + e) | 0;
                        },
                        ...
                        isPlainObject: function (e) {
                            if ("object" != (void 0 === e ? "undefined" : o(e)) || e.nodeType || e === e.window) return !1;
                            try {
                            ...
                            return n
                                ? ((e = e || []),
                                  ...
                                  t.forEach(function (t, n) {
                                      void 0 === o[n] ? (o[n] = t) : i.isPlainObject(t) ? (o[n] = i.merge(e[n], t)) : -1 === e.indexOf(t) && o.push(t);
                                  }),
                                  o)
                                : (e &&
                                      i.isPlainObject(e) &&
                                  ...
                                  Object.keys(t).forEach(function (n) {
                                      t[n] && i.isPlainObject(t[n]) && e[n] ? (o[n] = i.merge(e[n], t[n])) : (o[n] = t[n]);
                                  }),
                                  o);
                        },
                        now: function () {
                        ...
                        radixSort: function (e, t, i, n) {
                            if (((t = t || 0), (i = i || e.length), (n = n || 31), !(t >= i - 1 || 0 > n))) {
                        ...
                        randomizeRGB: function (e, t) {
                            var i,
                                ...
                                o = e.split(","),
                                r = "rgb(";
                            for (t = this.randomInt(t), i = 0; 3 > i; i++) 0 > (n = parseInt(o[i]) + t) ? (n = 0) : n > 255 && (n = 255), (r += n + ",");
                            return (r = r.substring(0, r.length - 1)), (r += ")");
                        },
                        getJSON: function (e) {
                            var t = new XMLHttpRequest(),
                                i = void 0 !== e.cache && e.cache ? e.url : e.url + "?t=" + Math.floor(1e4 * Math.random()) + Date.now();
                            (t.onreadystatechange = function () {
                                if (200 !== this.status) 0 !== this.status && console.warn("[Tools.getJSON] Error: " + this.status + " (" + this.statusText + ") :: " + e.url);
                                else {
                                    var t = null;
                                    try {
            ...
            function (e, t, i) {
                ...
                !(function (e) {
                    ...
                    function n(e) {
                        var t = "keyCode" in e ? e.keyCode : "which" in e ? e.which : 0,
                            i = (function () {
                                ...
                                return "keyIdentifier" in e && e.keyIdentifier in p ? p[e.keyIdentifier] : t in d ? d[t] : null;
                            })();
                        if (!i) return null;
                        var n = (function () {
                            var t = v[i.code];
                            return t ? (e.shiftKey && "shiftKey" in t ? t.shiftKey : t.key) : i.code;
                        })();
                    ...
                    o ||
                        ...
                        "DOM_KEY_LOCATION_STANDARD" in e.KeyboardEvent || (e.KeyboardEvent.DOM_KEY_LOCATION_STANDARD = 0),
                        "DOM_KEY_LOCATION_LEFT" in e.KeyboardEvent || (e.KeyboardEvent.DOM_KEY_LOCATION_LEFT = 1),
                        "DOM_KEY_LOCATION_RIGHT" in e.KeyboardEvent || (e.KeyboardEvent.DOM_KEY_LOCATION_RIGHT = 2),
                        "DOM_KEY_LOCATION_NUMPAD" in e.KeyboardEvent || (e.KeyboardEvent.DOM_KEY_LOCATION_NUMPAD = 3);
                    var r = window.KeyboardEvent.DOM_KEY_LOCATION_STANDARD,
                        ...
                        l = t(navigator.platform, "Win")
                            ...
                            ? "linux"
                            : t(navigator.userAgent, "iPad") || t(navigator.platform, "iPod") || t(navigator.platform, "iPhone")
                            ? "ios"
                            : "",
                        h = t(navigator.userAgent, "Chrome/")
                            ...
                            ? "ie"
                            : t(navigator.userAgent, "Gecko/index.html")
                            ? "moz"
                            : t(navigator.userAgent, "Opera/index.html")
                            ? "opera"
                            : "",
                        u = h + "-" + l,
                        d = {
                    ...
                    i(d, "moz", {
                        ...
                        i(d, "moz-mac", { 12: { code: "NumLock", location: c }, 173: { code: "Minus", keyCap: "-" } }),
                        ...
                        i(d, "safari-mac", { 91: { code: "OSLeft", location: s }, 93: { code: "OSRight", location: a }, 229: { code: "KeyQ", keyCap: "Q" } });
                    var p = {};
                    "cros" === l &&
                    ...
                    var f = [];
                    (f[s] = { 16: { code: "ShiftLeft", location: s }, 17: { code: "ControlLeft", location: s }, 18: { code: "AltLeft", location: s } }),
                        (f[a] = { 16: { code: "ShiftRight", location: a }, 17: { code: "ControlRight", location: a }, 18: { code: "AltRight", location: a } }),
                        (f[c] = { 13: { code: "NumpadEnter", location: c } }),
                        i(f[c], "moz", { 109: { code: "NumpadSubtract", location: c }, 107: { code: "NumpadAdd", location: c } }),
                    ...
                    try {
                        var y = o && "location" in new KeyboardEvent("");
                    } catch (e) {}
                    "KeyboardEvent" in e &&
                        ...
                        (e.identifyKey = function (e) {
                            if (!("code" in e)) {
                                ...
                                (e.code = t ? t.code : ""),
                                    ...
                                    (e.location = "location" in e ? e.location : "keyLocation" in e ? e.keyLocation : t && "location" in t ? t.location : r),
                                    (e.locale = "");
                            }
                        });
                })(window);
            ...
            function (e, t, i) {
                ...
                (n.computeCentroids = function (e) {
                    ...
                    for (t = 0, i = e.faces.length; t < i; t++)
                        ((n = e.faces[t]).centroid = new THREE.Vector3(0, 0, 0)), n.centroid.add(e.vertices[n.a]), n.centroid.add(e.vertices[n.b]), n.centroid.add(e.vertices[n.c]), n.centroid.divideScalar(3);
                }),
                    ...
                    (n.mergeVertexIds = function (e, t) {
                        ...
                        for (var n = i[1], o = i[0], r = e.slice(); r[0] !== n; ) r.push(r.shift());
                        for (var s = 0, a = t.slice(); a[0] !== o; ) if ((a.push(a.shift()), s++ > 10)) throw new Error("Unexpected state");
                    ...
                    (n.cleanPolygon = function (e, t) {
                        for (var i = [], n = t.vertices, o = 0; o < e.vertexIds.length; o++) {
                            var r,
                                s,
                                a,
                                c = n[e.vertexIds[o]];
                            0 === o
                                ? ((r = e.vertexIds[1]), (s = e.vertexIds[e.vertexIds.length - 1]))
                                : o === e.vertexIds.length - 1
                                ? ((r = e.vertexIds[0]), (s = e.vertexIds[e.vertexIds.length - 2]))
                                : ((r = e.vertexIds[o + 1]), (s = e.vertexIds[o - 1])),
                                (a = n[s]);
                            var l = n[r].clone().sub(c),
                                h = a.clone().sub(c),
                                u = l.angleTo(h);
                            if (u > Math.PI - 0.01 && u < Math.PI + 0.01) {
                                var d = [];
                                e.neighbours.forEach(function (t) {
                                    t.vertexIds.includes(e.vertexIds[o]) || d.push(t);
                                }),
                                    (e.neighbours = d);
                    ...
                    (n.isConvex = function (e, t) {
                        ...
                        for (var n = !0, o = [], r = 0; r < e.vertexIds.length; r++) {
                            var s,
                                a,
                                c = i[e.vertexIds[r]];
                            0 === r
                                ? ((s = i[e.vertexIds[1]]), (a = i[e.vertexIds[e.vertexIds.length - 1]]))
                                : r === e.vertexIds.length - 1
                                ? ((s = i[e.vertexIds[0]]), (a = i[e.vertexIds[e.vertexIds.length - 2]]))
                                : ((s = i[e.vertexIds[r + 1]]), (a = i[e.vertexIds[r - 1]]));
                            var l = s.clone().sub(c),
                                h = a.clone().sub(c),
                                u = l.angleTo(h);
                    ...
                    (n.isPointInPoly = function (e, t) {
                        for (var i = !1, n = -1, o = e.length, r = o - 1; ++n < o; r = n)
                            ((e[n].z <= t.z && t.z < e[r].z) || (e[r].z <= t.z && t.z < e[n].z)) && t.x < ((e[r].x - e[n].x) * (t.z - e[n].z)) / (e[r].z - e[n].z) + e[n].x && (i = !i);
                        return i;
                    }),
                    (n.isVectorInPolygon = function (e, t, i) {
                        ...
                        return (
                            t.vertexIds.forEach(function (e) {
                                (n = Math.min(i[e].y, n)), (o = Math.max(i[e].y, o)), r.push(i[e]);
                            }),
                ...
                (o.prototype.push = function (e) {
                    ...
                    (o.prototype.bubbleUp = function (e) {
                        for (var t = this.content.length, i = this.content[e], n = this.scoreFunction(i); ; ) {
                            var o = (e + 1) << 1,
                                r = o - 1,
                                s = null,
                                a = void 0;
                            if ((r < t && (a = this.scoreFunction(this.content[r])) < n && (s = r), o < t && this.scoreFunction(this.content[o]) < (null === s ? n : a) && (s = o), null === s)) break;
                            (this.content[e] = this.content[s]), (this.content[s] = i), (e = s);
                        }
                    });
                var r = function () {};
                (r.init = function (e) {
                    ...
                    (r.cleanUp = function (e) {
                        for (var t = 0; t < e.length; t++) {
                            var i = e[t];
                            delete i.f, delete i.g, delete i.h, delete i.cost, delete i.visited, delete i.closed, delete i.parent;
                        }
                    }),
                    (r.heap = function () {
                    ...
                    (r.search = function (e, t, i) {
                        this.init(e);
                        var n = this.heap();
                        for (n.push(t); n.size() > 0; ) {
                            var o = n.pop();
                            if (o === i) {
                                for (var r = o, s = []; r.parent; ) s.push(r), (r = r.parent);
                                return this.cleanUp(s), s.reverse();
                            }
                            o.closed = !0;
                            for (var a = this.neighbours(e, o), c = 0, l = a.length; c < l; c++) {
                                var h = a[c];
                                if (!h.closed) {
                                    var u = o.g + h.cost,
                                        d = h.visited;
                                    if (!d || u < h.g) {
                                        if (((h.visited = !0), (h.parent = o), !h.centroid || !i.centroid)) throw new Error("Unexpected state");
                                        (h.h = h.h || this.heuristic(h.centroid, i.centroid)), (h.g = u), (h.f = h.g + h.h), d ? n.rescoreElement(h) : n.push(h);
                                    }
                                }
                            }
                        }
                    ...
                    (r.heuristic = function (e, t) {
                        return n.distanceToSquared(e, t);
                    }),
                    (r.neighbours = function (e, t) {
                        for (var i = [], n = 0; n < t.neighbours.length; n++) i.push(e[t.neighbours[n]]);
                        return i;
                    });
                var s = 1,
                    a = function () {};
                (a.buildZone = function (e) {
                    ...
                    i.vertices.forEach(function (e) {
                        (e.x = n.roundNumber(e.x, 2)), (e.y = n.roundNumber(e.y, 2)), (e.z = n.roundNumber(e.z, 2));
                    }),
                    ...
                    return (
                        r.forEach(function (e) {
                            ...
                            e.forEach(function (o) {
                                var r = o.neighbours.map(function (t) {
                                        return s(e, t);
                                    }),
                                    a = o.neighbours.map(function (e) {
                                        return t._getSharedVerticesInOrder(o, e);
                                    });
                                (o.centroid.x = n.roundNumber(o.centroid.x, 2)),
                                    (o.centroid.y = n.roundNumber(o.centroid.y, 2)),
                                    (o.centroid.z = n.roundNumber(o.centroid.z, 2)),
                                    i.push({ id: s(e, o), neighbours: r, vertexIds: o.vertexIds, centroid: o.centroid, portals: a });
                            }),
                                o.groups.push(i);
                        }),
                        o
                    ...
                    (a._buildNavigationMesh = function (e) {
                        return n.computeCentroids(e), e.mergeVertices(), this._buildPolygonsFromGeometry(e);
                    }),
                    (a._buildPolygonGroups = function (e) {
                        ...
                        return (
                            e.polygons.forEach(function (e) {
                                void 0 === e.group && ((e.group = i++), n(e)), t[e.group] || (t[e.group] = []), t[e.group].push(e);
                            }),
                            t
                        );
                    }),
                    (a._buildPolygonNeighbours = function (e, t, i) {
                        var n = new Set(),
                            o = i.get(e.vertexIds[0]),
                            r = i.get(e.vertexIds[1]),
                            s = i.get(e.vertexIds[2]);
                        o.forEach(function (e) {
                            (r.has(e) || s.has(e)) && n.add(t.polygons[e]);
                        }),
                            r.forEach(function (e) {
                    ...
                    (a._buildPolygonsFromGeometry = function (e) {
                        for (var t = this, i = [], n = e.vertices, o = e.faceVertexUvs, r = new Map(), a = 0; a < n.length; a++) r.set(a, new Set());
                        e.faces.forEach(function (e) {
                            i.push({ id: s++, vertexIds: [e.a, e.b, e.c], centroid: e.centroid, normal: e.normal, neighbours: [] }), r.get(e.a).add(i.length - 1), r.get(e.b).add(i.length - 1), r.get(e.c).add(i.length - 1);
                        });
                        var c = { polygons: i, vertices: n, faceVertexUvs: o };
                        return (
                            i.forEach(function (e) {
                                t._buildPolygonNeighbours(e, c, r);
                            }),
                            c
                        );
                    }),
                    (a._getSharedVerticesInOrder = function (e, t) {
                        ...
                        if (
                            ...
                            return [];
                        o.has(i[0]) && o.has(i[i.length - 1]) && i.push(i.shift()), o.has(n[0]) && o.has(n[n.length - 1]) && n.push(n.shift());
                        var r = [];
                        return (
                            i.forEach(function (e) {
                        ...
                        for (var l = 1; l < o.length; l++) {
                            ...
                            if (n.triarea2(e, t, h) >= 0) {
                                if (!(n.vequal(e, t) || n.triarea2(e, i, h) < 0)) {
                                    r.push(i), (t = e = i), (i = e), (a = s = c), (c = s), (l = s);
                                    continue;
                                }
                                (t = h), (a = l);
                            }
                        }
                        return (0 !== r.length && n.vequal(r[r.length - 1], o[o.length - 1].left)) || r.push(o[o.length - 1].left), (this.path = r), r;
                    });
                var l,
                    h,
                    u,
                ...
                (v.createZone = function (e) {
                    ...
                    (v.prototype.getRandomNode = function (e, t, i, o) {
                        if (!this.zones[e]) return new THREE.Vector3();
                        (i = i || null), (o = o || 0);
                        var r = [];
                        return (
                            this.zones[e].groups[t].forEach(function (e) {
                                i && o ? n.distanceToSquared(i, e.centroid) < o * o && r.push(e.centroid) : r.push(e.centroid);
                            }),
                            n.sample(r) || new THREE.Vector3()
                        );
                    }),
                    (v.prototype.getClosestNode = function (e, t, i, o) {
                        void 0 === o && (o = !1);
                        var r = this.zones[t].vertices,
                            s = null,
                            a = 1 / 0;
                        return (
                            this.zones[t].groups[i].forEach(function (t) {
                                var i = n.distanceToSquared(t.centroid, e);
                                i < a && (!o || n.isVectorInPolygon(e, t, r)) && ((s = t), (a = i));
                            }),
                            s
                        );
                    }),
                    (v.prototype.findPath = function (e, t, i, n) {
                        var o = this.zones[i].groups[n],
                            s = this.zones[i].vertices,
                            a = this.getClosestNode(e, i, n),
                            l = this.getClosestNode(t, i, n, !0);
                        if (!a || !l) return null;
                        var h = r.search(o, a, l),
                            u = function (e, t) {
                    ...
                    (v.prototype.clampStep =
                        ...
                        function (e, t, i, n, o, r) {
                            var s = this.zones[n].vertices,
                                a = this.zones[n].groups[o],
                                c = [i],
                                v = {};
                            (v[i.id] = 0), (l = void 0), f.set(0, 0, 0), (h = 1 / 0), d.setFromCoplanarPoints(s[i.vertexIds[0]], s[i.vertexIds[1]], s[i.vertexIds[2]]), d.projectPoint(t, u), t.copy(u);
                            for (var m = c.pop(); m; m = c.pop()) {
                                p.set(s[m.vertexIds[0]], s[m.vertexIds[1]], s[m.vertexIds[2]]), p.closestPointToPoint(t, u), u.distanceToSquared(t) < h && ((l = m), f.copy(u), (h = u.distanceToSquared(t)));
                                var g = v[m];
                                if (!(g > 2))
                                    for (var y = 0; y < m.neighbours.length; y++) {
                                        var E = a[m.neighbours[y]];
                                        E.id in v || (c.push(E), (v[E.id] = g + 1));
                                    }
                            }
                            return r.copy(f), l;
                        })),
                            ...
                            this.position.distanceTo(this.targetPosition) < 0.1
                                ...
                                : (t.emit("navigation-start", { checkpoint: e }),
                                  "teleport" === this.data.mode &&
                                      (this.el.setAttribute("position", this.targetPosition), (this.checkpoint = null), t.emit("navigation-end", { checkpoint: e }), t.components["movement-controls"].updateNavLocation())));
                    },
                    ...
                    getVelocity: function () {
                        if (this.active) {
                            var e = this.data,
                                ...
                                o = this.checkpoint;
                            return this.sync(), i.distanceTo(n) < 0.1 ? ((this.checkpoint = null), this.el.emit("navigation-end", { checkpoint: o }), t.set(0, 0, 0)) : (t.setLength(e.animateSpeed), t);
                        }
                    },
                    sync: function () {
                        var e = this.offset,
                        ...
                        t.copy(this.el.getAttribute("position")), i.copy(this.checkpoint.object3D.getWorldPosition()), i.add(this.checkpoint.components.checkpoint.getOffset()), e.copy(i).sub(t);
                    },
                });
            },
            {},
        ...
        12: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("gamepad-controls", {
                    GamepadButton: n,
                    schema: { controller: { default: 0, oneOf: [0, 1, 2, 3] }, enabled: { default: !0 }, debug: { default: !1 }, camera: { default: "[camera]", type: "selector" }, rotationSensitivity: { default: 2 } },
                    init: function () {
                    ...
                    getVelocityDelta: function () {
                        var e = this.getDpad(),
                            ...
                            n = e.y || t.y,
                            o = new THREE.Vector3();
                        return Math.abs(i) > 0.2 && (o.x += i), Math.abs(n) > 0.2 && (o.z += n), o;
                    },
                    ...
                    updateRotation: function (e) {
                        if (this.isRotationActive()) {
                            ...
                            r && (n.rotation.copy(o.pitchObject.rotation), i.rotation.copy(o.yawObject.rotation));
                            ...
                            Math.abs(s.x) <= 0.2 && (s.x = 0),
                                ...
                                (i.rotation.y -= s.x),
                                (n.rotation.x -= s.y),
                                (n.rotation.x = Math.max(-Math.PI / 2, Math.min(Math.PI / 2, n.rotation.x))),
                                t.camera.object3D.rotation.set(n.rotation.x, i.rotation.y, 0),
                                r && (o.pitchObject.rotation.copy(n.rotation), o.yawObject.rotation.copy(i.rotation));
                        }
                    },
                    updateButtonState: function () {
                        ...
                        if (this.data.enabled && e)
                            for (var t = 0; t < e.buttons.length; t++)
                                e.buttons[t].pressed && !this.buttons[t] ? this.emit(new o("gamepadbuttondown", t, e.buttons[t])) : !e.buttons[t].pressed && this.buttons[t] && this.emit(new o("gamepadbuttonup", t, e.buttons[t])),
                    ...
                    getGamepad: function () {
                        var e = navigator.getGamepads && navigator.getGamepads()[this.data.controller],
                            t = this.el.sceneEl.components["proxy-controls"];
                        return (t && t.isConnected() && t.getGamepad(this.data.controller)) || e;
                    },
                    ...
                    getDpad: function () {
                        ...
                        return e.buttons[n.DPAD_RIGHT]
                            ? new THREE.Vector2((e.buttons[n.DPAD_RIGHT].pressed ? 1 : 0) + (e.buttons[n.DPAD_LEFT].pressed ? -1 : 0), (e.buttons[n.DPAD_UP].pressed ? -1 : 0) + (e.buttons[n.DPAD_DOWN].pressed ? 1 : 0))
                            : new THREE.Vector2();
                    },
        ...
        13: [
            function (e, t, i) {
                "use strict";
                e("./checkpoint-controls"), e("./gamepad-controls"), e("./keyboard-controls"), e("./touch-controls"), e("./movement-controls"), e("./trackpad-controls");
            },
            { "./checkpoint-controls": 11, "./gamepad-controls": 12, "./keyboard-controls": 14, "./movement-controls": 15, "./touch-controls": 16, "./trackpad-controls": 17 },
        ],
        14: [
            function (e, t, i) {
                "use strict";
                ...
                t.exports = AFRAME.registerComponent("keyboard-controls", {
                    ...
                    init: function () {
                        (this.dVelocity = new THREE.Vector3()), (this.localKeys = {}), (this.listeners = { keydown: this.onKeyDown.bind(this), keyup: this.onKeyUp.bind(this), blur: this.onBlur.bind(this) }), this.attachEventListeners();
                    },
                    isVelocityActive: function () {
                    ...
                    getVelocityDelta: function () {
                        ...
                        return (
                            ...
                            e.enabled &&
                                ((t.KeyW || t.ArrowUp) && (this.dVelocity.z -= 1), (t.KeyA || t.ArrowLeft) && (this.dVelocity.x -= 1), (t.KeyS || t.ArrowDown) && (this.dVelocity.z += 1), (t.KeyD || t.ArrowRight) && (this.dVelocity.x += 1)),
                    ...
                    attachEventListeners: function () {
                        window.addEventListener("keydown", this.listeners.keydown, !1), window.addEventListener("keyup", this.listeners.keyup, !1), window.addEventListener("blur", this.listeners.blur, !1);
                    },
                    ...
                    onBlur: function () {
                        for (var e in this.localKeys) this.localKeys.hasOwnProperty(e) && delete this.localKeys[e];
                    },
                    emit: function (e) {
                        "__keyboard-controls-proxy" in e && this.el.emit(e.type, e), this.el.emit(e.type + ":" + e.code, new n(e.type, e)), this.data.debug && console.log(e.type + ":" + e.code);
                    },
                ...
                t.exports = AFRAME.registerComponent("movement-controls", {
                    ...
                    init: function () {
                        ...
                        (this.velocityCtrl = null),
                            ...
                            (this.navGroup = null),
                            (this.navNode = null),
                            e.sceneEl.hasLoaded ? this.injectControls() : e.sceneEl.addEventListener("loaded", this.injectControls.bind(this));
                    },
                    update: function (e) {
                        var t = this.el,
                            i = this.data,
                            n = t.sceneEl.systems.nav;
                        t.sceneEl.hasLoaded && this.injectControls(), n && i.constrainToNavMesh !== e.constrainToNavMesh && (i.constrainToNavMesh ? n.addAgent(this) : n.removeAgent(this));
                    },
                    injectControls: function () {
                        for (var e, t = this.data, i = 0; i < t.controls.length; i++) (e = t.controls[i] + "-controls"), this.el.components[e] || this.el.setAttribute(e, "");
                    },
                            ...
                            if (o) {
                                ...
                                if (s.enabled) {
                                    ...
                                    var a = this.velocityCtrl,
                                        c = this.velocity;
                                    if (a)
                                        if ((o / 1e3 > 0.2 ? c.set(0, 0, 0) : this.updateVelocity(o), s.constrainToNavMesh && !1 !== a.isNavMeshConstrained)) {
                                            ...
                                            (this.navGroup = null === this.navGroup ? l.getGroup(e) : this.navGroup),
                                                (this.navNode = this.navNode || l.getNode(e, this.navGroup)),
                                                (this.navNode = l.clampStep(e, t, this.navGroup, this.navNode, i)),
                                                r.object3D.position.copy(i);
                                        } else
                                            r.hasAttribute("velocity") ? r.setAttribute("velocity", c) : ((r.object3D.position.x += (c.x * o) / 1e3), (r.object3D.position.y += (c.y * o) / 1e3), (r.object3D.position.z += (c.z * o) / 1e3));
                                }
                            }
                        };
                    })(),
                    updateVelocityCtrl: function () {
                        ...
                        if (e.enabled) {
                            for (var t = 0, i = e.controls.length; t < i; t++) {
                                ...
                                if (n && n.isVelocityActive()) return void (this.velocityCtrl = n);
                            }
                            this.velocityCtrl = null;
                        }
                    },
                        ...
                        return function (i) {
                            ...
                            if (r) {
                                if (!r.getVelocityDelta) {
                                    ...
                                    if (r.getPositionDelta) return void s.copy(r.getPositionDelta(i).multiplyScalar(1e3 / i));
                                    throw new Error("Incompatible movement controls: ", r);
                                }
                                n = r.getVelocityDelta(i);
                            }
                            if ((o.hasAttribute("velocity") && !a.constrainToNavMesh && s.copy(this.el.getAttribute("velocity")), n && a.enabled)) {
                                var c = a.camera;
                                t.copy(c.object3D.quaternion), t.premultiply(o.object3D.quaternion), n.applyQuaternion(t);
                                var l = n.length();
                                a.fly ? (s.copy(n), s.multiplyScalar(16.66667 * this.data.speed)) : (e.set(n.x, n.z), e.setLength(l * this.data.speed * 16.66667), (s.x = e.x), (s.z = e.y));
                            }
                        };
                    })(),
                });
            ...
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("touch-controls", {
                    ...
                    addEventListeners: function () {
                        var e = this.el.sceneEl,
                            t = e.canvas;
                        t ? (t.addEventListener("touchstart", this.onTouchStart), t.addEventListener("touchend", this.onTouchEnd)) : e.addEventListener("render-target-loaded", this.addEventListeners.bind(this));
                    },
                    removeEventListeners: function () {
                        var e = this.el.sceneEl && this.el.sceneEl.canvas;
                        e && (e.removeEventListener("touchstart", this.onTouchStart), e.removeEventListener("touchend", this.onTouchEnd));
                    },
                    isVelocityActive: function () {
                    ...
                    onTouchStart: function (e) {
                        (this.direction = -1), this.data.reverseEnabled && 2 === e.touches.length && (this.direction = 1), e.preventDefault();
                    },
        ...
        17: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("trackpad-controls", {
                    schema: { enabled: { default: !0 }, enableNegX: { default: !0 }, enablePosX: { default: !0 }, enableNegZ: { default: !0 }, enablePosZ: { default: !0 }, mode: { default: "touch", oneOf: ["swipe", "touch", "press"] } },
                    init: function () {
                    ...
                    onTouchEnd: function (e) {
                        "swipe" == this.data.mode && (this.startingAxisData = []), (this.isMoving = !1), e.preventDefault();
                    },
                    ...
                    handleSwipeAxis: function (e) {
                        ...
                        if ((0 === this.startingAxisData.length && this.canRecordAxis && ((this.canRecordAxis = !1), (this.startingAxisData[0] = i[0]), (this.startingAxisData[1] = i[1])), this.startingAxisData.length > 0)) {
                            ...
                            t.enableNegX && i[0] < this.startingAxisData[0] && (n = -1),
                                ...
                                t.enablePosZ && i[1] > this.startingAxisData[1] && (o = -1),
                                t.enableNegZ && i[1] < this.startingAxisData[1] && (o = 1);
                            var r = Math.abs(this.startingAxisData[1] - i[1]);
                            Math.abs(this.startingAxisData[0] - i[0]) > r ? ((this.zVel = 0), (this.xVel = n), (this.isMoving = !0)) : ((this.xVel = 0), (this.zVel = o), (this.isMoving = !0));
                        }
                    },
                    handleTouchAxis: function (e) {
                        ...
                        t.enableNegX && i[0] < 0 && (n = -1),
                            ...
                            Math.abs(i[0]) > Math.abs(i[1]) ? ((this.zVel = 0), (this.xVel = n)) : ((this.xVel = 0), (this.zVel = o));
                    },
                });
            },
            {},
        ...
        18: [
            function (e, t, i) {
                ...
                var o = { once: THREE.LoopOnce, repeat: THREE.LoopRepeat, pingpong: THREE.LoopPingPong };
                        ...
                        if (e) {
                            ...
                            this.activeActions.forEach(function (e) {
                                "duration" in i && t.duration && e.setDuration(t.duration),
                                    "clampWhenFinished" in i && (e.clampWhenFinished = t.clampWhenFinished),
                                    ("loop" in i || "repetitions" in i) && e.setLoop(o[t.loop], t.repetitions),
                                ...
                                for (
                                    ...
                                    if (r.name.match(s)) {
                                        ...
                                        (c.enabled = !0),
                                            ...
                                            c.setLoop(o[t.loop], t.repetitions).fadeIn(t.crossFadeDuration).play(),
            ...
            function (e, t, i) {
                ...
                (THREE.FBXLoader = e("../../lib/FBXLoader")),
                    (t.exports = AFRAME.registerComponent("fbx-model", {
                        ...
                        load: function (e) {
                            (this.model = e), this.el.setObject3D("mesh", e), this.el.emit("model-loaded", { format: "fbx", model: e });
                        },
                        remove: function () {
            ...
            function (e, t, i) {
                ...
                var n = e("../../lib/fetch-script")(),
                    o = (function () {
                        var e = void 0;
                        return function () {
                            return (e = e || n("../rawgit.com/mrdoob/three.js/r86/examples/js/loaders/GLTFLoader.js"));
                        };
                    })();
                        ...
                        n &&
                            ...
                            this.loaderPromise.then(function () {
                                e.loader.load(n, function (e) {
                                    (t.model = e.scene), (t.model.animations = e.animations), i.setObject3D("mesh", t.model), i.emit("model-loaded", { format: "gltf", model: t.model });
                                });
                            }));
                    },
                    remove: function () {
        ...
        21: [
            function (e, t, i) {
                "use strict";
                e("./animation-mixer"), e("./fbx-model"), e("./gltf-model-legacy"), e("./object-model");
            },
            { "./animation-mixer": 18, "./fbx-model": 19, "./gltf-model-legacy": 20, "./object-model": 22 },
        ],
        22: [
            function (e, t, i) {
                "use strict";
                t.exports = AFRAME.registerComponent("object-model", {
                    ...
                    load: function (e) {
                        (this.model = e), this.el.setObject3D("mesh", e), this.el.emit("model-loaded", { format: "json", model: e });
                    },
                    remove: function () {
                        this.model && this.el.removeObject3D("mesh");
                    },
            ...
            function (e, t, i) {
                ...
                function n(e, t, i, n) {
                    e &&
                        ...
                        e.traverse(function (e) {
                            if (e.isMesh) {
                                (function (e) {
                                    return e ? (Array.isArray(e) ? e : e.materials ? e.materials : [e]) : [];
                                })(e.material).forEach(function (e) {
                                    (!e || "envMap" in e) && ((t.length && -1 === t.indexOf(e.name)) || ((e.envMap = i), (e.reflectivity = n), (e.needsUpdate = !0)));
                                });
                            }
                        }));
                }
                t.exports = AFRAME.registerComponent("cube-env-map", {
                    ...
                    update: function (e) {
                        ...
                        this.data.enableBackground && !e.enableBackground ? this.setBackground(this.texture) : !this.data.enableBackground && e.enableBackground && this.setBackground(null);
                    },
                    remove: function () {
        ...
        25: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("grab", {
                    ...
                    onGripOpen: function () {
                        var e = this.hitEl;
                        (this.grabbing = !1), e && (e.removeState(this.GRABBED_STATE), (this.hitEl = void 0), this.system.removeConstraint(this.constraint), (this.constraint = null));
                    },
                    onHit: function (e) {
                        var t = e.detail.el;
                        t &&
                            ...
                            this.grabbing &&
                            !this.hitEl &&
                            (t.addState(this.GRABBED_STATE), (this.hitEl = t), (this.constraint = new CANNON.LockConstraint(this.el.body, t.body)), this.system.addConstraint(this.constraint));
                    },
                });
            },
            {},
        ...
        26: [
            function (e, t, i) {
                "use strict";
                e("./checkpoint"), e("./cube-env-map"), e("./grab"), e("./jump-ability"), e("./kinematic-body"), e("./mesh-smooth"), e("./normal-material"), e("./sphere-collider");
            },
            { "./checkpoint": 23, "./cube-env-map": 24, "./grab": 25, "./jump-ability": 27, "./kinematic-body": 28, "./mesh-smooth": 29, "./normal-material": 30, "./sphere-collider": 31 },
        ],
        27: [
            function (e, t, i) {
                "use strict";
                t.exports = AFRAME.registerComponent("jump-ability", {
                    ...
                    schema: { on: { default: "keydown:Space gamepadbuttondown:0" }, playerHeight: { default: 1.764 }, maxJumps: { default: 1 }, distance: { default: 5 }, debug: { default: !1 } },
                    init: function () {
                        (this.velocity = 0), (this.numJumps = 0);
                        var e = this.beginJump.bind(this),
                            t = this.data.on.split(" ");
                        this.bindings = {};
                        for (var i = 0; i < t.length; i++) (this.bindings[t[i]] = e), this.el.addEventListener(t[i], e);
                        (this.bindings.collide = this.onCollide.bind(this)), this.el.addEventListener("collide", this.bindings.collide);
                    },
                    remove: function () {
                        for (var e in this.bindings) this.bindings.hasOwnProperty(e) && (this.el.removeEventListener(e, this.bindings[e]), delete this.bindings[e]);
                        this.el.removeEventListener("collide", this.bindings.collide), delete this.bindings.collide;
                    },
                    beginJump: function () {
                        if (this.numJumps < this.data.maxJumps) {
                            ...
                            this.el.setAttribute("velocity", { x: i.x, y: t, z: i.z }), this.numJumps++, this.el.emit("jumpstart");
                        }
                    },
                    onCollide: function () {
        ...
        28: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("kinematic-body", {
                    dependencies: ["velocity"],
                    schema: { mass: { default: 5 }, radius: { default: 1.3 }, linearDamping: { default: 0.05 }, enableSlopes: { default: !0 }, enableJumps: { default: !1 } },
                    init: function () {
                        (this.system = this.el.sceneEl.systems.physics), this.system.addComponent(this);
                        var e = this.el,
                            t = this.data,
                            i = new CANNON.Vec3().copy(e.object3D.getWorldPosition(new THREE.Vector3()));
                        (this.body = new CANNON.Body({ material: this.system.getMaterial("staticMaterial"), position: i, mass: t.mass, linearDamping: t.linearDamping, fixedRotation: !0 })),
                            this.body.addShape(new CANNON.Sphere(t.radius), new CANNON.Vec3(0, t.radius, 0)),
                            (this.body.el = this.el),
                            (this.el.body = this.body),
                            this.system.addBody(this.body),
                            e.hasAttribute("wasd-controls") && console.warn("[kinematic-body] Not compatible with wasd-controls, use movement-controls.");
                    },
                    remove: function () {
                    ...
                    beforeStep: function (e, t) {
                        if (t) {
                            var i = this.el,
                                n = this.data,
                                o = this.body;
                            n.enableJumps || o.velocity.set(0, 0, 0), o.position.copy(i.getAttribute("position"));
                        }
                    },
                    step: (function () {
                        var e = new THREE.Vector3(),
                        ...
                        return function (o, r) {
                            if (r) {
                                ...
                                (r = Math.min(r, 1e3 * this.system.data.maxInterval)), n.set(0, 0, 0), e.copy(this.el.getAttribute("velocity")), s.velocity.copy(e);
                                for (var d, p = 0; (d = u[p]); p++)
                                    if (d.enabled) {
                                        ...
                                        s.velocity.dot(i) < -1e-6 && i.y <= 0.5
                                            ? e.projectOnPlane(i)
                                            : i.y > 0.5 && (c = s.id === d.bi.id ? Math.abs(d.rj.y + d.bj.position.y) : Math.abs(d.ri.y + d.bi.position.y)) > l && ((l = c), n.copy(i), (h = s.id === d.bi.id ? d.bj : d.bi));
                                    }
                                t.copy(e).normalize(),
                                    h && (!a.enableJumps || t.y < 0.5)
                                        ? (a.enableSlopes ? n.y < 1 - 1e-6 && n.copy(this.raycastToGround(h, n)) : n.set(0, 1, 0), e.projectOnPlane(n))
                                        : this.system.driver.world && e.add(this.system.driver.world.gravity.scale((4 * r) / 1e3)),
                                    s.velocity.copy(e),
                    ...
                    raycastToGround: function (e, t) {
                        ...
                        return (i = new CANNON.Ray(o, r))._updateDirection(), i.intersectBody(e), i.hasHit ? ((n = i.result.hitNormalWorld), Math.abs(n.y) > Math.abs(t.y) ? n : t) : t;
                    },
                });
            },
            {},
        ...
        30: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("normal-material", {
                    init: function () {
                        (this.material = new THREE.MeshNormalMaterial({ flatShading: !0 })), (this.applyMaterial = this.applyMaterial.bind(this)), this.el.addEventListener("object3dset", this.applyMaterial);
                    },
                    remove: function () {
        ...
        31: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("sphere-collider", {
                    schema: { objects: { default: "" }, state: { default: "collided" }, radius: { default: 0.05 }, watch: { default: !0 } },
                    init: function () {
                        (this.observer = null), (this.els = []), (this.collisions = []), (this.handleHit = this.handleHit.bind(this)), (this.handleHitEnd = this.handleHitEnd.bind(this));
                    },
                    remove: function () {
                        this.pause();
                    },
                    play: function () {
                        var e = this.el.sceneEl;
                        this.data.watch && ((this.observer = new MutationObserver(this.update.bind(this, null))), this.observer.observe(e, { childList: !0, subtree: !0 }));
                    },
                    pause: function () {
                    ...
                    update: function () {
                        var e = this.data,
                            t = void 0;
                        (t = e.objects ? this.el.sceneEl.querySelectorAll(e.objects) : this.el.sceneEl.children), (this.els = Array.prototype.slice.call(t));
                    },
                    tick: (function () {
                        var e = new THREE.Vector3(),
                            t = new THREE.Vector3(),
                            ...
                            o.getObject3D("mesh") &&
                                ...
                                this.els.forEach(function (i) {
                                    ...
                                    i.isEntity &&
                                        ...
                                        (o = Math.sqrt(2 * h * h)),
                                        l.getCenter(t),
                                        o && (c = e.distanceTo(t)) < o + a && (s.push(i), n.set(i, c)));
                                }),
                                s
                                    .sort(function (e, t) {
        ...
        32: [
            ...
            { "./nav-agent": 33, "./nav-mesh": 34, "./system": 35 },
        ],
        33: [
            function (e, t, i) {
                "use strict";
                        ...
                        return function (n, o) {
                            ...
                            if (s.active) {
                                if (!this.path.length) {
                                    ...
                                    (this.group = this.group || this.system.getGroup(l)), (this.path = this.system.getPath(l, e.copy(s.destination), this.group) || []), r.emit("navigation-start");
                                }
                                if (!this.path.length) return console.warn("[nav] Unable to find path to %o.", s.destination), this.el.setAttribute("nav-agent", { active: !1 }), void r.emit("navigation-end");
                                var h = r.object3D.position,
                                    u = this.path[0];
                                t.subVectors(u, h);
                                var d = void 0;
                                if (t.length() < c) {
                                    if ((this.path.shift(), !this.path.length)) return this.el.setAttribute("nav-agent", { active: !1 }), void r.emit("navigation-end");
                                    i.copy(h), (d = this.path[0]);
                                } else i.copy(t.setLength(c)).add(h), (d = u);
                                (d.y = h.y), r.object3D.lookAt(d), a.ray.origin.copy(i), (a.ray.origin.y += 1.5), (a.ray.direction.y = -1);
                                var p = a.intersectObject(this.system.getNavMesh());
                                p.length ? (t.subVectors(p[0].point, h), h.add(t.setLength(c))) : h.copy(i);
                            }
                        };
                    })(),
                });
        ...
        34: [
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerComponent("nav-mesh", {
                    init: function () {
                        (this.system = this.el.sceneEl.systems.nav), (this.hasLoadedNavMesh = !1), this.el.addEventListener("object3dset", this.loadNavMesh.bind(this));
                    },
                    play: function () {
                    ...
                    loadNavMesh: function () {
                        ...
                        if (e) {
                            ...
                            if (
                                ...
                                var n = i.geometry.isBufferGeometry ? new THREE.Geometry().fromBufferGeometry(i.geometry) : i.geometry.clone();
                                t.updateMatrixWorld(), n.applyMatrix(i.matrixWorld), this.system.setNavMeshGeometry(n), (this.hasLoadedNavMesh = !0);
                            }
                        }
                    },
                });
            ...
            function (e, t, i) {
                ...
                t.exports = AFRAME.registerSystem("nav", {
                    ...
                    clampStep: function (e, t, i, n, s) {
                        return this.navMesh ? (n ? o.clampStep(e, t, n, r, i, s) : (s.copy(t), this.getNode(t, i))) : (s.copy(t), null);
                    },
                });
            },
            { "three-pathfinding": 10 },
        ],
        36: [
            function (e, t, i) {
                "use strict";
                t.exports = AFRAME.registerPrimitive("a-grid", {
                    defaultComponents: {
                        ...
                        material: { src: "url(https://cdn.rawgit.com/donmccurdy/aframe-extras/v1.16.3/assets/grid.png)", repeat: "75 75" },
                    },
        ...
        37: [
            function (e, t, i) {
                "use strict";
                var n = e("lib/hex-grid.min.html"),
                    o = e("../../lib/default-hex-grid");
                (t.exports.Primitive = AFRAME.registerPrimitive("a-hexgrid", { defaultComponents: { hexgrid: {} }, mappings: { src: "hexgrid.src" } })),
                    (t.exports.Component = AFRAME.registerComponent("hexgrid", {
                        ...
                        addMesh: function (e) {
                            ...
                            t.fromJSON(e);
                            var i = new n.Board(t);
                            i.generateTilemap(), this.el.setObject3D("mesh", i.group), this.addMaterial();
                        },
            ...
            { "../../lib/default-hex-grid": 6, "../../lib/hex-grid.min.js": 8 },
        ],
        38: [
            function (e, t, i) {
                "use strict";
                    ...
                    (t.exports.Component = AFRAME.registerComponent("ocean", {
                        ...
                        play: function () {
                            var e = this.el,
                                ...
                                n = new THREE.PlaneGeometry(t.width, t.depth, t.density, t.density);
                            n.mergeVertices(), (this.waves = []);
                            for (var o, r = 0, s = n.vertices.length; r < s; r++)
                                (o = n.vertices[r]), this.waves.push({ z: o.z, ang: Math.random() * Math.PI * 2, amp: t.amplitude + Math.random() * t.amplitudeVariance, speed: (t.speed + Math.random() * t.speedVariance) / 1e3 });
                            i || ((i = {}).material = new THREE.MeshPhongMaterial({ color: t.color, transparent: t.opacity < 1, opacity: t.opacity, shading: THREE.FlatShading })),
                        ...
                        tick: function (e, t) {
                            if (t) {
                                for (var i, n, o = this.mesh.geometry.vertices, r = 0; (i = o[r]); r++) (n = this.waves[r]), (i.z = n.z + Math.sin(n.ang) * n.amp), (n.ang += n.speed * t);
        ...
        39: [
            function (e, t, i) {
                ...
                (t.exports.Primitive = AFRAME.registerPrimitive("a-tube", {
                    ...
                    mappings: { path: "tube.path", segments: "tube.segments", radius: "tube.radius", "radial-segments": "tube.radialSegments", closed: "tube.closed" },
                })),
                    (t.exports.Component = AFRAME.registerComponent("tube", {
                        schema: { path: { default: [] }, segments: { default: 64 }, radius: { default: 1 }, radialSegments: { default: 8 }, closed: { default: !1 } },
                        init: function () {
                            var e = this.el,
                                t = this.data,
                                i = e.components.material;
                            if (t.path.length) {
                                var n = new THREE.CatmullRomCurve3(
                                        t.path.map(function (e) {
                                            return (e = e.split(" ")), new THREE.Vector3(Number(e[0]), Number(e[1]), Number(e[2]));
                                        })
                                    ),
                                    o = new THREE.TubeGeometry(n, t.segments, t.radius, t.radialSegments, t.closed);
                                i || ((i = {}).material = new THREE.MeshPhongMaterial()), (this.mesh = new THREE.Mesh(o, i.material)), this.el.setObject3D("mesh", this.mesh);
                            } else console.error("[a-tube] `path` property expected but not found.");
                        },
                        update: function (e) {
        ...
        40: [
            ...
            { "./a-grid": 36, "./a-hexgrid": 37, "./a-ocean": 38, "./a-tube": 39 },
        ],
    },
    {},
    [1]
